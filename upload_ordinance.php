...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $number = $_POST['ord_number'];
    $author = $_POST['ord_author'];
    $title = $_POST['ord_title'];
    ...
    if (move_uploaded_file($file["tmp_name"], $targetFilePath)) {
        // Insert record into ordinances table
        $stmt = $conn->prepare("INSERT INTO ordinances (number, author, title, file_path,uploaded_at) VALUES (?, ?, ?, ?, NOW())");

...
<head>
  ...
  <title>Municipality of Ramos — Official Site</title>
  <meta name="description" content="Official website of the Municipality of Ramos — Sangguniang Bayan, ordinances, services, and updates." />
...
body {
  ...
  background: linear-gradient(180deg, var(--bg), #3431f5ff);
  color: #111827;
  line-height: 1.45;
  background-attachment: fixed;
  background-image:
    radial-gradient(circle at top left, rgba(10, 102, 241, 0.15)),
    radial-gradient(circle at bottom right, rgba(1, 17, 87, 0.12));
}

/* make everything fill full width */
.container {
  width: 100%;
  max-width: none;
  margin: 0;
